...
def recommend_portfolio(intent_request):
    ...
    if not (int(age) > 0 and int(age) < 65 and int(investment_amount) > 5000): 
        return close(
            ...
            "Fulfilled",
            {
                ...
                but you are either not born, too old, or don't
                have enough investable assets.  Return when you
                have been born, grown younger than 65, or have more
                than $5,000.
                """
            },
        )
        ...
        return close(
            ...
            "Fulfilled",
            {
                "contentType": "PlainText",
                "content": """Thank you for your information,
                I recommend a portfolio of 60% bonds(AGG)
                and 40% equities(SPY).
                """
            },
        )
        ...
        return close(
            ...
            "Fulfilled",
            {
                "contentType": "PlainText",
                "content": """Thank you for your information,
                I recommend a portfolio of 40% bonds(AGG)
                and 60% equities(SPY).
                """
            },
        )
        ...
        return close(
            ...
            "Fulfilled",
            {
                "contentType": "PlainText",
                "content": """Thank you for your information,
                I recommend a portfolio of 20% bonds(AGG)
                and 80% equities(SPY).
                """
            },
        )
        ...
        return close(
            ...
            "Fulfilled",
            {
                "contentType": "PlainText",
                "content": """Thank you for your information,
                I recommend not investing because an entirely
                bond portfolio in a rising interest
                environment will perform extremely poorly. There
                is no risk free return currently.
                """
            },
        )
